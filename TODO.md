...
- [x] **Product Columns Visibility & Reordering**: Custom column visibility toggle and native drag-and-drop column reordering persisted in localStorage. (Task 1-5: 완료)
