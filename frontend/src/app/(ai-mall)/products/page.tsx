  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.tableSection}>
        {error && <div style={{ color: 'var(--red)', padding: '20px', textAlign: 'center' }}>{error}</div>}
        
        {isLoading ? (
          <div style={{ padding: '60px', textAlign: 'center', color: 'var(--ink-muted-48)' }}>
                ...
                {products.map((p) => {
                  ...
                  return (
                    <tr key={p.id}>
                      ...
                      <td>
                        <div className={styles.keywordWrapper}>
                          {p.keywords && p.keywords.length > 0 ? (
                            ...
                            <span style={{ color: 'var(--ink-muted-48)', fontSize: '12px' }}>없음</span>
                          )}
                      ...
                      <td style={{ color: 'var(--ink-muted-48)', fontSize: '13px', whiteSpace: 'nowrap' }}>
              ...
              {Array.from({ length: totalPages }).map((_, i) => {
                ...
                if (totalPages > 5 && Math.abs(page - pNum) > 2 && pNum !== 1 && pNum !== totalPages) {
                  if (pNum === 2 || pNum === totalPages - 1) {
                    return <span key={pNum} style={{ margin: '0 4px', color: 'var(--ink-muted-48)' }}>...</span>;
                  }
                  return null;
                }
                return (
