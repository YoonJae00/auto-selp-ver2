...
@pytest.mark.asyncio
async def test_coupang_get_attribute_schema_cached():
    provider = CoupangAttributeSchemaProvider(redis_client=AsyncMock())
    
    cached_data = '{"market_code": "coupang", "category_id": "456", "attributes": [{"name": "브랜드", "required": true, "data_type": "STRING", "input_type": "INPUT", "unit": null, "valid_values": null}], "meta": {}}'
